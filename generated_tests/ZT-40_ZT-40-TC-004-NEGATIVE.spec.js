...
// Test ID: ZT-40-TC-004-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-40: Registration fails with invalid email address', () => {
  ...
  test('Registration fails with invalid email address', async ({ page }) => {
