...
// Test ID: ZT-38-TC-003-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-38: Registration fails with missing required fields', () => {
  ...
  test('Registration fails with missing required fields', async ({ page }) => {
    ...
    // Expected: Error message displays indicating name field is required
