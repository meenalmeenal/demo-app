...
test.describe('ZT-3: User attempts to log in with incorrect password', () => {
  ...
  test('User attempts to log in with incorrect password', async ({ page }) => {
    ...
    // Expected: Password field shows masked characters, but login button becomes enabled
    await page.fill('#password', 'wrongpassword');
    // Step 4: Click the login button
    // Expected: An error message is displayed indicating that the password is incorrect, login fails
