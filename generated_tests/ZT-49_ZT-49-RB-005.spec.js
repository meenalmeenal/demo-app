...
test.describe('ZT-49: Failure handling: system rejects invalid or unauthorised sce', () => {
  ...
  test('Failure handling: system rejects invalid or unauthorised scenario for Invalid pa', async ({ page }) => {
    ...
    await page.goto(baseUrl);
    // Step 2: Attempt to violate the acceptance criterion by providing invalid or missing data for: Invalid password shows error message.
