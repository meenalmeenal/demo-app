...
// Test ID: ZT-38-TC-004-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-38: Registration fails with invalid email address', () => {
  ...
  test('Registration fails with invalid email address', async ({ page }) => {
    ...
    // Expected: Error message displays indicating email address is invalid
