...
// Test ID: ZT-PR2-TC-006-UI-VALIDATION
...
test.describe('ZT-PR2: Password reset page field validation', () => {
  ...
  test('Password reset page field validation', async ({ page }) => {
    ...
    // Expected: Error message is displayed, 'Passwords do not match'
    await page.getByRole('textbox', { name: /password/i }).or(page.locator('#password, input[type=password]')).first().fill('Secure123, Secure1234');
  });
});