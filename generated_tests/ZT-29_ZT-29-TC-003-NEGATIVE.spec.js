...
// Test ID: ZT-29-TC-003-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-29: Login with empty email field shows validation error', () => {
  ...
  test('Login with empty email field shows validation error', async ({ page }) => {
    ...
    // Expected: Validation error is displayed below the email field, login button remains disabled
