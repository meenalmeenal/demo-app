...
// Test ID: ZT-42-TC-004-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-42: User fails to register with invalid email', () => {
  ...
  test('User fails to register with invalid email', async ({ page }) => {
    ...
    // Expected: Error message displays indicating email is invalid
