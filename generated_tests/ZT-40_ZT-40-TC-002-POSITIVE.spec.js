...
// Auto-generated test case for ZT-40
// Test ID: ZT-40-TC-002-POSITIVE
// Type: positive, Priority: P1

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-40: User successfully registers with valid credentials and speci', () => {
  ...
  test('User successfully registers with valid credentials and special characters', async ({ page }) => {
    ...
    await page.locator('input[type="text"], textarea').first().fill('John_Doe');
