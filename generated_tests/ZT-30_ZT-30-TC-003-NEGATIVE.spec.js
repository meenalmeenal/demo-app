...
// Test ID: ZT-30-TC-003-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-30: User attempts to log in with empty email field', () => {
  ...
  test('User attempts to log in with empty email field', async ({ page }) => {
    ...
    // Expected: Validation error message is displayed for the email field, and login is not successful
