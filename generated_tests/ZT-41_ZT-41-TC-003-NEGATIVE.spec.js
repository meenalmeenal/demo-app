...
// Test ID: ZT-41-TC-003-NEGATIVE
// Type: negative, Priority: P2

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-41: Registration fails with missing name', () => {
  ...
  test('Registration fails with missing name', async ({ page }) => {
    ...
    // Expected: Error message displays indicating that name is required
