...
// Test ID: ZT-48-RB-014
// Type: negative, Priority: P3

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-48: Failure handling: system rejects invalid or unauthorised sce', () => {
  ...
  test('Failure handling: system rejects invalid or unauthorised scenario for Session ex', async ({ page }) => {
    ...
    await page.goto(baseUrl);
    // Step 2: Attempt to violate the acceptance criterion by providing invalid or missing data for: Session expires after 30 minutes of inactivity.
