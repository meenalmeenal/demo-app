...
// Test ID: ZT-37-TC-005-BOUNDARY
// Type: boundary, Priority: P3

const baseUrl = process.env.APP_BASE_URL || 'http://localhost:3000';

test.describe('ZT-37: Registration with minimum length password', () => {
  ...
  test('Registration with minimum length password', async ({ page }) => {
    ...
    // Step 3: Enter a password of minimum length in the password field
    // Expected: Password field shows masked characters
    await page.getByRole('textbox', { name: /password/i }).or(page.locator('#password, input[type=password]')).first().fill('Pass1234');
